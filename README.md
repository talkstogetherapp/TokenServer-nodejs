...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/talkstogetherapp/TokenServer-nodejs)
...
- 如果发现了示例代码的 bug, 欢迎提交 [issue](https://github.com/talkstogetherapp/TokenServer-nodejs/issues)
